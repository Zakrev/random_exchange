...
CM_O_FILES := $(OBJ_DIR)/main.o $(OBJ_DIR)/data.o $(OBJ_DIR)/exp.o $(OBJ_DIR)/randomize.o
...
$(OBJ_DIR)/exp.o: $(SRC_DIR)/randomize.c
	gcc -c -o $(OBJ_DIR)/randomize.o $(SRC_DIR)/randomize.c
